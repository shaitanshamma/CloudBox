...
import com.geerkbrains.netty.example.client.ClientDownload;
import com.geerkbrains.netty.example.client.Main;
            ...
            clientBootstrap.handler(new ChannelInitializer<SocketChannel>() {
                protected void initChannel(SocketChannel socketChannel) throws Exception {
                    socketChannel.pipeline().addLast(new ObjectDecoder(50 * 1024 * 1024, ClassResolvers.cacheDisabled(null)),
                            new ObjectEncoder(), new ClientDownload(controller));
